...
interface DashboardData {
  ...
  recentTransactions: {
    id: string; buyer: { name: string }; date: string; totalAmount: number
    type: string; status: string; items: { productName: string }[]
  }[]
}
